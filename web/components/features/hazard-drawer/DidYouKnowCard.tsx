...
export const DidYouKnowCard: React.FC<DidYouKnowCardProps> = ({
  ...
  return (
    <div className={`glass-card p-4 rounded-xl border border-white/10 bg-forest-surface/40 ${className}`}>
      <div className="flex items-start space-x-3">
        <span className="material-symbols-outlined text-hazard-amber text-lg">lightbulb</span>
        <div>
          <div className="text-xs font-semibold text-white">Did you know?</div>
